...
const Contact =() => {
  ...
  return (
    <div className="px-16 ml-16 md-mx:px-6 !my-10 font-mono" id="Contact">
       ...
       <div data-aos="flip-left" data-aos-duration="1600" className=" w-[70%] shadow-[0_0_10px_0_#64FFDA50] m-auto flex flex-col gap-6 border border-primaryColor rounded-3xl p-8 ">

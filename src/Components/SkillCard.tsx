...
const SkillBadge=(skills:[])=>{
    return skills.map((skill:any, index:number)=><div key={index} className="flex gap-2 p-2 !border border-textColor rounded-2xl items-center">
...
const SkillCard =(props:any)=>{
    return <div data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-in-sine" className="w-[43%] shadow-[0_0_10px_0_#64FFDA50] rounded-3xl  mb-3 border border-primaryColor p-5 bs-mx:p-3 sm-mx:w-full ">
